 ...
 */
@Controller
@RequestMapping(value = MRRTIndexController.INDEX_CONTROLLER)
public class MRRTIndexController {
    ...
    @RequestMapping(method = RequestMethod.GET,value = MRRTIndexController.INDEX_VIEW)
