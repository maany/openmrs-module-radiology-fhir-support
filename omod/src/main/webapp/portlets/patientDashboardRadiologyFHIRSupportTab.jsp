...
<div id="create-report">
    ...
    <table>
        ...
        <c:forEach items="${model.reports}" var="report" varStatus="i">
            <tr>
                <td><a href="">pic</a></td>
                <td><a href="${pageContext.request.contextPath}/ws/fhir/DiagnosticReport/${report.encounter.uuid}">fhir</a></td>
                <td><a href="${pageContext.request.contextPath}/module/radiologyfhirsupport/report/view/${report.id}.form">${report.name}</a></td>
